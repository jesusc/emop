...
public enum When implements Enumerator {
	...
	/**
	 * The '<em><b>LOAD MODEL</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #LOAD_MODEL_VALUE
	 * @generated
	 * @ordered
	 */
	LOAD_MODEL(1, "LOAD_MODEL", "LOAD_MODEL");
	...
	/**
	 * The '<em><b>LOAD MODEL</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>LOAD MODEL</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #LOAD_MODEL
	 ...
	 * @ordered
	 */
	public static final int LOAD_MODEL_VALUE = 1;
	...
	public static When get(int value) {
		switch (value) {
			...
			case LOAD_MODEL_VALUE: return LOAD_MODEL;
		}
		return null;
	}
