...
public class AnnotationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnnotationsPackage.ANNOTATION_SPEC: {
				AnnotationSpec annotationSpec = (AnnotationSpec)theEObject;
				T result = caseAnnotationSpec(annotationSpec);
			...
			case AnnotationsPackage.MODEL_ANNOTATION: {
				...
				if (result == null) result = caseAnnotation(modelAnnotation);
				if (result == null) result = caseEClass(modelAnnotation);
				if (result == null) result = caseEClassifier(modelAnnotation);
				if (result == null) result = caseENamedElement(modelAnnotation);
				if (result == null) result = caseEModelElement(modelAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnnotationsPackage.OBJECT_ANNOTATION: {
				...
				if (result == null) result = caseEClass(objectAnnotation);
				if (result == null) result = caseEClassifier(objectAnnotation);
				if (result == null) result = caseENamedElement(objectAnnotation);
				if (result == null) result = caseEModelElement(objectAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnnotationsPackage.CLASS_ANNOTATION: {
				ClassAnnotation classAnnotation = (ClassAnnotation)theEObject;
				T result = caseClassAnnotation(classAnnotation);
				if (result == null) result = caseAnnotation(classAnnotation);
				if (result == null) result = caseEClass(classAnnotation);
			...
			case AnnotationsPackage.FIELD_ANNOTATION: {
				FieldAnnotation fieldAnnotation = (FieldAnnotation)theEObject;
				T result = caseFieldAnnotation(fieldAnnotation);
				if (result == null) result = caseAnnotation(fieldAnnotation);
				if (result == null) result = caseEClass(fieldAnnotation);
				if (result == null) result = caseEClassifier(fieldAnnotation);
				if (result == null) result = caseENamedElement(fieldAnnotation);
				if (result == null) result = caseEModelElement(fieldAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnnotationsPackage.SEMANTIC_ACTION: {
				SemanticAction semanticAction = (SemanticAction)theEObject;
				T result = caseSemanticAction(semanticAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnnotationsPackage.JAVA_CODE: {
				JavaCode javaCode = (JavaCode)theEObject;
				T result = caseJavaCode(javaCode);
				if (result == null) result = caseSemanticAction(javaCode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Annotation Spec</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Annotation Spec</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAnnotationSpec(AnnotationSpec object) {
		return null;
	}
