...
public class MyBasicDiagnostic extends org.eclipse.emf.common.util.BasicDiagnostic {
	  /**
	   * The severity.
	   * @see #getSeverity
	   */
	  ...
	  public MyBasicDiagnostic(BasicDiagnostic original)
	  {
		  this(original.getSeverity(), original.getSource(), original.getCode(), original.getMessage(), original.getData().toArray());
	  }
	  
	  /**
	   * Default Constructor (no initialization for local parameters)
	   */
	  public MyBasicDiagnostic()
	  {
	    super();
	  }

	  public MyBasicDiagnostic(String source, int code, String message, Object[] data) 
	  {
	    this.source = source;
	    this.code = code;
	  ...
	  public MyBasicDiagnostic(int severity, String source, int code, String message, Object[] data)
	  {
	    this(source, code, message, data);
	    this.severity = severity;
	  }

	  public MyBasicDiagnostic(String source, int code, List<? extends Diagnostic> children, String message, Object[] data)
	  {
	    this(source, code, message, data);
	    if (children != null)
	    {
	...
	public void remove(Diagnostic diagnostic) {
		this.children.remove(diagnostic);
		this.recomputeSeverity();
	}
